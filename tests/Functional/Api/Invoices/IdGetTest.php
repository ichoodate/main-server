...
namespace Tests\Functional\Api\Invoices;
...
class IdGetTest extends _TestCase {
    ...
    {
        $this->factory(Invoice::class)->create(['id' => 11]);
        $this->factory(Invoice::class)->create(['id' => 12]);
    ...
    {
        $this->factory(User::class)->create(['id' => 1]);
        $this->factory(Invoice::class)->create(['id' => 11, 'user_id' => 2]);
