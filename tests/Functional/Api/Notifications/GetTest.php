...
namespace Tests\Functional\Api\Notifications;
...
class GetTest extends _TestCase {
    ...
    protected $uri = 'api/notifications';
    ...
    public function test()
    {
        ...
        $this->factory(Notification::class)->create(['id' => 13, 'user_id' => 2]);
        $this->factory(Notification::class)->create(['id' => 14, 'user_id' => 1]);
