...
class StatureUserSelfKwdPvtCreatingServiceTest extends _TestCase {
    ...
    public function testCallbackAuthUser()
    {
        $this->when(function ($proxy, $serv) {
            ...
            $stature          = $this->mMock();
            $statureQuery     = $this->mMock();
            $statureBaseQuery = $this->mMock();
            $kwdPvt           = $this->mMock();
            $kwdPvtQuery      = $this->mMock();
            $kwdPvtBaseQuery  = $this->mMock();

            InstanceMocker::add(Stature::class, $stature);
            ModelMocker::query($stature, $statureQuery);
            QueryMocker::qSelect($statureQuery, Stature::ID);
            QueryMocker::getQuery($statureQuery, $statureBaseQuery);
            ...
            QueryMocker::qWhereIn($kwdPvtQuery, UserSelfKwdPvt::KEYWORD_ID, $statureBaseQuery);
