...
class PaymentFindingServiceTest extends _TestCase {
    ...
    public function testLoaderPermittedUser()
    {
        $this->when(function ($proxy, $serv) {
            ...
            $model    = $this->factory(Payment::class)->make();
            $return   = null;
        ...
        $this->when(function ($proxy, $serv) {
            ...
            $authUser = $this->factory(User::class)->make();
            $model    = $this->factory(Payment::class)->make([Payment::USER_ID => $authUser->getKey()]);
            $return   = $authUser;
