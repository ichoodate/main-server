...
class CardActivityRequiredCoinCountingServiceTest extends _TestCase {
    ...
    public function testArrBindNames()
    {
        $this->verifyArrBindNames([
            ...
            'card_flip'
                => 'flip status for {{card}} and for {{auth_user}}',

            'match_open'
                => 'open status for match of {{card}} and for {{auth_user}}',

            'match_propose'
                => 'propose status for match of {{card}} and for {{auth_user}}'
        ]);
    }
    ...
    public function testLoaderEvaluatedCount()
    {
        $this->when(function ($proxy, $serv) {
            ...
            ModelMocker::aliasQuery($subInst, $subQuery);
