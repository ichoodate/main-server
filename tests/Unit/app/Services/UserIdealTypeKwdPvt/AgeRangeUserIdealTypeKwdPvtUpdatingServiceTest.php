...
class AgeRangeUserIdealTypeKwdPvtUpdatingServiceTest extends _TestCase {
    ...
    public function testCallbackAuthUser()
    {
        $this->when(function ($proxy, $serv) {
            ...
            $ageRange          = $this->mMock();
            $ageRangeQuery     = $this->mMock();
            $ageRangeBaseQuery = $this->mMock();
            $kwdPvt            = $this->mMock();
            $kwdPvtQuery       = $this->mMock();
            $kwdPvtBaseQuery   = $this->mMock();

            InstanceMocker::add(AgeRange::class, $ageRange);
            ModelMocker::query($ageRange, $ageRangeQuery);
            QueryMocker::qSelect($ageRangeQuery, AgeRange::ID);
            QueryMocker::getQuery($ageRangeQuery, $ageRangeBaseQuery);
            ...
            QueryMocker::qWhereIn($kwdPvtQuery, UserIdealTypeKwdPvt::KEYWORD_ID, $ageRangeBaseQuery);
