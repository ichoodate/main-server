...
class CareerUserIdealTypeKwdPvtUpdatingServiceTest extends _TestCase {
    ...
    public function testCallbackAuthUser()
    {
        $this->when(function ($proxy, $serv) {
            ...
            $career            = $this->mMock();
            $careerQuery       = $this->mMock();
            $careerBaseQuery   = $this->mMock();
            $kwdPvt            = $this->mMock();
            $kwdPvtQuery       = $this->mMock();
            $kwdPvtBaseQuery   = $this->mMock();

            InstanceMocker::add(Career::class, $career);
            ModelMocker::query($career, $careerQuery);
            QueryMocker::qSelect($careerQuery, Career::ID);
            QueryMocker::getQuery($careerQuery, $careerBaseQuery);
            ...
            QueryMocker::qWhereIn($kwdPvtQuery, UserIdealTypeKwdPvt::KEYWORD_ID, $careerBaseQuery);
