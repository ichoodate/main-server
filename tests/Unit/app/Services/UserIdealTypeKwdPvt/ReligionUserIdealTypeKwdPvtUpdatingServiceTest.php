...
class ReligionUserIdealTypeKwdPvtUpdatingServiceTest extends _TestCase {
    ...
    public function testCallbackAuthUser()
    {
        $this->when(function ($proxy, $serv) {
            ...
            QueryMocker::qWhereIn($kwdPvtQuery, UserIdealTypeKwdPvt::KEYWORD_ID, $religionBaseQuery);
