...
class ProfilableMergingServiceTest extends _TestCase {
    ...
    public function testLoaderCreated()
    {
        $this->when(function ($proxy, $serv) {
            ...
            ModelMocker::newCollection(Profilable::class, $return);

            ModelMocker::create(Profilable::class, [
                Profilable::KEYWORD_ID => 11,
                Profilable::USER_ID    => $authUser->getKey()
            ], $newModel1);

            ModelMocker::create(Profilable::class, [
                Profilable::KEYWORD_ID => 22,
                Profilable::USER_ID    => $authUser->getKey()
            ], $newModel2);

            ModelMocker::create(Profilable::class, [
                Profilable::KEYWORD_ID => 33,
                Profilable::USER_ID    => $authUser->getKey()
            ], $newModel3);
    ...
    public function testLoaderExisted()
    {
        $this->when(function ($proxy, $serv) {
            ...
            ModelMocker::aliasQuery(Profilable::class, $query);
            QueryMocker::lockForUpdate($query);
            QueryMocker::qWhereIn($query, Profilable::KEYWORD_ID, $keywordIds);
    ...
    public function testLoaderExistedKeywordIds()
    {
        $this->when(function ($proxy, $serv) {
            ...
            CollectionMocker::pluck($existed, Profilable::KEYWORD_ID);
