...
class CardFactory extends ModelFactory
{
    ...
    {
        return [
            Card::ID => static::faker()->unique()->randomNumber(8),

            Card::GROUP_ID => static::faker()->unique()->randomNumber(8),

            Card::MATCH_ID => static::faker()->unique()->randomNumber(8),

            Card::CHOOSER_ID => static::faker()->unique()->randomNumber(8),

            Card::SHOWNER_ID => static::faker()->unique()->randomNumber(8),

            Card::CREATED_AT => static::faker()->dateTimeThisYear->format('Y-m-d H:i:s'),

            Card::UPDATED_AT => static::faker()->dateTimeThisYear->format('Y-m-d H:i:s'),
        ];
    }
}
